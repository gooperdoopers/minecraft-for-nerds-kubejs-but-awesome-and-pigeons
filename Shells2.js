...
event.shaped(
  Item.of('cbcmoreshells:steel_projectile_rack_quickfiring_breech'),
  [
    ' A ',
  ...
  {
    A: 'createbigcannons:qickfiring_mechanism',
    B: 'cbcmoreshells:steel_projectile_rack_chamber'
  }
)

event.shaped(
  Item.of('cbcmoreshells:rocket_bracket'),
  [
    '   ',
  ...
  {
    A: 'create:iron_sheet',
    B: 'minecraft:slimeball',
  }
)

event.shaped(
  Item.of('cbcmoreshells:steel_projectile_rack_chamber'),
  [
    'C C',
